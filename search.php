...
// если в строке поиска что-то написано
if (isset($_REQUEST['search'])) {$search=$_REQUEST['search'];} 
//вывод товаров, в которых присутствует это слово
            ...
            <div class="catalog__item flex ">
                ...
                <div class="jcsb flex">
                    ...
                    <div class="catalog__thirdblock flex jcsb">
                        ...
                        <a href="handlers/cart.php?id=<?=$id['id']?>"><p><img class="icon" src="img/cart.png" alt=""></p></a>
                    </div>
                </div>
            </div>
            <?endforeach;?>
