    ...
    <div class="flex jcsb">
        <div class="filter">
            ...
            <ul>
                ...
                <a href="videocards.php"><li>Видеокарты</li></a>
                <a href=""><li>Оперативная память</li></a>  
            </ul>
            <a class="add__btn" href="add.php">Добавить продукт</a>
        </div>
            ...
            <div class="catalog__item flex ">
                ...
                <div class="jcsb flex">
                    ...
                    <div class="catalog__thirdblock flex jcsb">
                        <p>В наличии</p>
                        <a href="edit.php?id=<?=$id['id']?>"><p><img class="icon" src="../img/edit.png" alt=""></p></a>
                        <a href="handlers/delete.php?id=<?=$id['id']?>"><p><img class="icon" src="../img/cross.png" alt=""></p></a>
                    </div>
                </div>
            </div>
            <?endforeach;?>
